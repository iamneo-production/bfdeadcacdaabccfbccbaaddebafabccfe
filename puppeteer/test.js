...
(async () => {
  ...
  try{
    await page.goto('https://8081-bfdeadcacdaabccfbccbaaddebafabccfe.project.examly.io/');
...
(async () => {
  ...
  try{
    ...
    const result1 = await page.evaluate(()=>{
      let button = document.querySelector("#field1");
      return button.innerHTML;
    })
    const result2 = await page.evaluate(()=>{
      let button = document.querySelector("#yesMayBe");
      return button.innerHTML;
    })
...
(async () => {
  ...
  try{
    ...
    const result1 = await page.evaluate(()=>{
      let button = document.querySelector("#bestColour");
      return button.innerHTML;
    })
